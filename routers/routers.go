...
import (
	...
	"net/http"
	"papershare_backend/controller"
	"papershare_backend/logger"
	"papershare_backend/middlewares"
	"time"
)
...
func SetupRouter(mode string) *gin.Engine {
	...
	v1.POST("/upload", controller.UploadFileHandler)              // 上传文件
	v1.GET("/download/:filename", controller.DownloadFileHandler) //下载文件
	// 中间件
